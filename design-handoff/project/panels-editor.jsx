...
const PANEL_TEMPLATES = [
	{
		...
		make: () => ({
			kind: "text",
			meta: "about",
			title: "Howling since May 2026",
			body: "Web dev streamer, blue wolf, owner of MrDemonWolf, Inc.",
			pills: ["he/him", "CT timezone"],
		}),
	},
	{
		id: "link",
		...
		make: () => ({
			...
			meta: "discord",
			title: "The Howl",
			body: "Invite-only den for regulars.",
			cta: "Request invite",
			href: "#",
		}),
	},
	{
		...
		make: () => ({
			...
			meta: "recent project",
			title: "Wolf Run",
			body: "Endless-runner about a blue wolf.",
			cta: "Watch progress",
			href: "#",
		}),
	},
	...
	},
	{
		...
		make: () => ({
			...
			meta: "clip",
			title: "Latest clip",
			body: "Wolf Run jump physics, before/after",
			href: "#",
		}),
	},
];
...
const DEFAULT_PANELS = [
	{
		...
		meta: "about",
		title: "Howling since May 2026",
		body: "Web dev streamer, blue wolf, owner of MrDemonWolf, Inc. Building tools and games at the intersection of furry creativity and clean code.",
		pills: ["he/him", "CT timezone"],
	},
	{
		id: "p2",
		...
		meta: "discord",
		title: "The Howl",
		body: "An invite-only den for regulars. Notes, clip drops, and the occasional 3am voice channel. New here? DM in chat first.",
		cta: "Request invite",
		href: "#",
	},
	{
		...
		meta: "support · ko-fi",
		title: "Buy a coffee",
		body: "Tips help cover server bills for the den and keep streams ad-free. One-time or monthly. No tier theatrics.",
		cta: "Open Ko-fi",
		href: "#",
	},
	{
		...
		title: "Gear & rig",
		items: [
			"5950X · 4080 · 64GB · Shure SM7B",
			"GoXLR · Sony A6400 cam",
			"NixOS host · OBS → self-hosted Owncast",
		],
	},
	{
		id: "p5",
		...
		meta: "recent project",
		title: "Wolf Run",
		body: "A small endless-runner about a blue wolf and increasingly silly hats. Built live on stream in TypeScript + WebGL.",
		cta: "Watch progress",
		href: "#",
	},
];
...
function PanelView({
	...
	return (
		<div className={`panel ${editing ? "is-edit" : ""}`} data-id={panel.id}>
			...
			{panel.kind === "image" && (
				<div className="panel-img" aria-hidden="true" />
			)}
			{panel.kind === "embed" && (
				<div className="panel-embed" aria-hidden="true">
			...
			{panel.cta && (
				<a className="lnk" href={panel.href || "#"}>
					{panel.cta} →
				</a>
			)}
		</div>
...
function PanelsApp() {
	...
	const update = (panel) =>
		setPanels((ps) => ps.map((p) => (p.id === panel.id ? panel : p)));
